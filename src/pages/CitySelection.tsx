          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {mockCities.map((city, index) => (
              ...
              >
                ...
                {/* Hover Effect for Active Cities */}
                {city.is_active && (
                  <motion.div
                    className="absolute inset-0 rounded-2xl bg-gradient-to-r from-green-500/0 via-green-500/5 to-green-500/0"
                    initial={{ opacity: 0 }}
